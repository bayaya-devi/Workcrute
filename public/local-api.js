(() => {
  ...
  async function request(path, options = {}) {
    ...
    if (path === "/api/auth/register" && options.method === "POST") {
      ...
      const account = { id: id(), email: String(body.email).toLowerCase(), password: body.password, role: body.role === "recruiter" ? "recruiter" : "candidate", firstName: body.firstName, lastName: body.lastName, phone: body.phone, profile: {} };
